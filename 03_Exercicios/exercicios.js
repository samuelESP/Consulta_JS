...
if (media < 5){
    ...
    console.log("Aluno em situação de reucuperação");
}else{
...
let produtoNaEtiqueta = 10;
let parcelas= 1;
let formaDePagamento= "Débito";  

if(parcelas == 1){
    if(formaDePagamento=="Débito"){
        console.log("R$"+produtoNaEtiqueta * 0.9);
    }else if(formaDePagamento="PIX" || formaDePagamento == "Dinheiro"){
        console.log("R$"+produtoNaEtiqueta * 0.85);
    }else{
        console.log("Forma de pagamento não reconhecida");
    }
}else if(parcelas == 2){
    console.log("R$"+produtoNaEtiqueta);
}else{
    console.log("R$"+produtoNaEtiqueta*1.1);
